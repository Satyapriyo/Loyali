        ...
        <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 text-black px-6 py-2.5 sm:px-3.5 sm:before:flex-1 -mt-4 pt-4">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                <p className="text-sm/6 text-gray-900">
                    ...
                    The project is currently live and being tested on the <span className="font-bold text-white bg-loyali-primary py-1 px-2 rounded-lg">Solana devnet.</span>
                </p>
            ...
            <div className="flex flex-1 justify-end">
                <button type="button" className="-m-3 p-3 focus-visible:outline-offset-[-4px]">
                    ...
                    <svg
                        viewBox="0 0 2 2"
                        aria-hidden="true"
                        className="h-5 w-5 fill-gray-900 transition-all group-hover:fill-gray-600" />
                </button>
            </div>
        </div>
    )
